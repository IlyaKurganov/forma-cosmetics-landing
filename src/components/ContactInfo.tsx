            ...
            <div className="md:w-1/2 flex items-center justify-center bg-primary p-8 md:p-12">
              <div className="text-center">
                <Avatar className="w-40 h-40 border-4 border-white mx-auto mb-6">
                  <AvatarImage
                    src="https://iimg.su/s/13/yhdBuhw6UdDhl46CYEUrYTNuECNyzkXqLrJenYdC.jpg"
                    alt="Ирина Трубинова"
                  />
                  <AvatarFallback className="text-3xl bg-primary-200">
                    ИТ
                  </AvatarFallback>
                </Avatar>
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  >
                    <MessageCircle className="mr-2 h-4 w-4" /> Написать в
                    WhatsApp
                  </Button>
                </div>
              </div>
