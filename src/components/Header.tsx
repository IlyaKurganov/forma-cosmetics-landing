      ...
      <div className="container px-4 mx-auto">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            <a href="#promo" className="text-gray-700 hover:text-primary font-medium">Акции</a>
            <a href="#brands" className="text-gray-700 hover:text-primary font-medium">Бренды</a>
            <a href="#about" className="text-gray-700 hover:text-primary font-medium">О компании</a>
